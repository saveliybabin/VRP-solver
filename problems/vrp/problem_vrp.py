...
from heurictics.op_tool import main
from heurictics.distance_matrix import distance_function
...
#         print(torch.arange(1, graph_size, out=pi.data.new()).view(1, -1).expand(batch_size, graph_size))
