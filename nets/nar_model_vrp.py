...
class NARModel(nn.Module):
    ...
    def forward(self, nodes, graph, car_num, supervised=False, targets=None, class_weights=None, return_pi=False):
        """
        Args:
        ...
        if self.problem.NAME == 'cvrp' and supervised:
            ...
            if return_pi:
                ...
                logits, _, pi, cost = self.greedy_search(nodes, graph, car_num)
